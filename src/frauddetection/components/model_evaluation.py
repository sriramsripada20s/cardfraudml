...
from frauddetection.utils.common import save_json
    ...
    def log_into_mlflow(self):
        ...
        with mlflow.start_run():
            ...
            if tracking_url_type_store != "file":
                ...
                mlflow.sklearn.log_model(model, "model", registered_model_name="Decision Tree Classifier Model")
            else:
